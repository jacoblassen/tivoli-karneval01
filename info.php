...
<head>
	...
	<meta name="description" content="Information om karneval i Tivoli. Find priser og praktisk info om karnevallet. Læs ofte stillede spørgsmål og svar." />
	<meta name="keywords" content="Tivoli, karneval, åbningstider, åbningstid, information, info, praktisk, priser, pris, ofte, stillede, spørgsmål," />
				...
				<div class="frametophtag" id="infoFrameTop">
					<div class="infoNavBox">
	      			...
	      			<div class="infoNavBox">
            			...
            			<a href="#" onclick="hideshow(praktiskDiv, ofteDiv, infoPilRight, infoPilLeft)"><span id="ofteSpan">Ofte Stillede Spørgsmål</span></a>
            	</div><!--infoNavLeftBox-->
            </div><!--frametophtag-->
        </div><!--frametop-->
